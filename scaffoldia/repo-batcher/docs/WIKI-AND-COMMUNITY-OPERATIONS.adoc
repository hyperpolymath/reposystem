...
[source,bash]
----
1. Enable wiki in settings    ✅ Can do via API
2. First page creation        ❌ Blocks all automation!
3. Everything else            ✅ Can automate after step 2
----
...
* ✅ Checks if wiki already initialized (skips if exists)
* ✅ Enables feature via API first
...
* ✅ Checks if files already exist (reports status)
* ✅ Creates `.github/` directory if missing
* ✅ Skips identical files (no unnecessary changes)
* ✅ Reports created/updated/skipped counts
* ✅ Dry-run support
* ✅ Works with local repositories (no API needed)
...
* ✅ GitHub verified badges eligibility

**Ready to use on 565+ repositories!** 🚀
