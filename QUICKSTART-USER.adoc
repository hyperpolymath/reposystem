...
// Replace reposystem, Reposystem — See README.adoc for details., just run, Reposystem started successfully. with actuals
= reposystem — Quick Start for Users
:toc:
:toclevels: 2

== What is reposystem?

Reposystem — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./reposystem-portable
----
...
[source]
----
Reposystem started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/reposystem/wiki
