...
[NOTE]
====
Machine-readable context lives in the six `.scm` files (`.machine_readable/6a2/STATE.a2ml`, `.machine_readable/6a2/ECOSYSTEM.a2ml`, `.machine_readable/6a2/META.a2ml`, `.machine_readable/6a2/PLAYBOOK.a2ml`, `.machine_readable/6a2/AGENTIC.a2ml`, `.machine_readable/6a2/NEUROSYM.a2ml`). Agents should read them before mutating the graph so they know the current completion, blockers, and the OPSM/doc narrative.
====
...
├── .machine_readable/6a2/STATE.a2ml            # Project state
├── .machine_readable/6a2/ECOSYSTEM.a2ml        # Ecosystem position
├── .machine_readable/6a2/META.a2ml             # Architecture decisions
├── .machine_readable/6a2/PLAYBOOK.a2ml         # Operational runbooks
├── .machine_readable/6a2/AGENTIC.a2ml          # AI agent patterns
├── .machine_readable/6a2/NEUROSYM.a2ml         # Neural-symbolic integration
