...
|*Source modules* |22 |Rust CLI (14 commands, config, graph, scanner,
tui, lib, main), 1 Ada spec, 1 Idris2 ABI
...
|*E2E tests* |20 |NEW: Binary smoke tests, scan operations, config
loading, security

|*Property-based tests* |12 |NEW: Determinism, consistency, graph
properties, roundtrip fidelity

|*Aspect tests* |14 |NEW: Security, error handling, performance, bounded
execution

|*Criterion benchmarks* |6 |NEW: Graph construction, edges, export
(DOT), forge ops, queries
...
* [x] E2E tests (20 tests) - smoke tests, scan operations, config
loading, security
* [x] Property-based tests (12 tests) - determinism, consistency, graph
properties
* [x] Aspect tests (14 tests) - security, error handling, performance,
bounded execution
* [x] Criterion benchmarks (6 suites) - construction, edges, export,
queries, forge ops
...
* [ ] GUI rendering/interaction tests (958 ReScript files - requires
test framework)
...
* [x] Unit tests: 9 (50 invariant + 3 hello_yard + 9 inline = 62 total
coverage)
* [x] Smoke tests: 20 E2E tests covering –help, –version, scan
operations
...
* [x] Contract tests: Aspect tests validate API contracts (error
